...
class AppState extends ChangeNotifier {
  ...
  String tr(String key) {
    final Map<String, Map<String, String>> translations = {
      ...
      'update_status': {'en': 'Update Status', 'id': 'Perbarui Status'},
      'current_status': {'en': 'Current Status', 'id': 'Status Saat Ini'},
      'select_new_status': {'en': 'Select New Status', 'id': 'Pilih Status Baru'},
      'order': {'en': 'Order', 'id': 'Pesanan'},
      'status_updated': {'en': 'Status updated successfully', 'id': 'Status berhasil diperbarui'},
      'process_order': {'en': 'Process Order', 'id': 'Proses Pesanan'},
      'ship_order': {'en': 'Ship Order', 'id': 'Kirim Pesanan'},
      'mark_delivered': {'en': 'Mark as Delivered', 'id': 'Tandai Sudah Sampai'},
      'cancel_order': {'en': 'Cancel Order', 'id': 'Batalkan Pesanan'},
      'accept_order': {'en': 'Accept Order', 'id': 'Terima Pesanan'},
      'confirm_receipt': {'en': 'Confirm Receipt', 'id': 'Konfirmasi Penerimaan'},
      'give_review': {'en': 'Give a review for this order', 'id': 'Berikan review untuk pesanan ini'},
      'rating': {'en': 'Rating', 'id': 'Penilaian'},
      'review_optional': {'en': 'Review (Optional)', 'id': 'Review (Opsional)'},
      'review_placeholder': {'en': 'How was your experience with this product?', 'id': 'Bagaimana pengalaman Anda dengan produk ini?'},
      'order_confirmed': {'en': 'Order confirmed successfully!', 'id': 'Pesanan berhasil dikonfirmasi!'},
      'total_amount': {'en': 'Total Amount', 'id': 'Total Pembayaran'},
      'date': {'en': 'Date', 'id': 'Tanggal'},
      'auto_accept': {'en': 'Auto-accept', 'id': 'Otomatis diterima'},
      'status_pending': {'en': 'Pending', 'id': 'Menunggu'},
      'status_processing': {'en': 'Processing', 'id': 'Diproses'},
      'status_shipped': {'en': 'Shipped', 'id': 'Dikirim'},
      'status_delivered': {'en': 'Delivered', 'id': 'Terkirim'},
      'status_completed': {'en': 'Completed', 'id': 'Selesai'},
      'status_cancelled': {'en': 'Cancelled', 'id': 'Dibatalkan'},
      'desc_pending': {'en': 'Waiting for processing', 'id': 'Menunggu diproses'},
      'desc_processing': {'en': 'Order is being prepared', 'id': 'Pesanan sedang disiapkan'},
      'desc_shipped': {'en': 'Order is on the way', 'id': 'Pesanan dalam perjalanan'},
      'desc_delivered': {'en': 'Order has arrived', 'id': 'Pesanan sudah sampai'},
      'desc_completed': {'en': 'Order completed', 'id': 'Pesanan selesai'},
      'desc_cancelled': {'en': 'Order cancelled', 'id': 'Pesanan dibatalkan'},
    };
